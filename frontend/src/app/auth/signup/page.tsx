      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-lg font-semibold" style={{ color: "var(--txt-1)" }}>Create your account</h1>
            <p className="text-sm" style={{ color: "var(--txt-3)" }}>Start trading with execution intelligence</p>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-sm" style={{ color: "var(--txt-3)" }}>
          ...
          <Link href="/auth/signin" className="font-medium text-solviolet hover:text-solviolet/80">
            Sign in
          </Link>
        </p>
      </div>
